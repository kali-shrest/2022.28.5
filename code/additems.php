...
$query= "INSERT INTO `products`(`product_id`, `product_cat`, `product_title`, `product_price`, `product_img`, `product_keywords`, `product_brand`, `product_quantity`, `product_flag`) VALUES ('','$catid','$product_title','$product_price','$product_image','$product_search_keywords','$brandid','$product_quantity','')";

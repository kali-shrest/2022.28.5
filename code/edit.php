...
<li><a href="adminfinal.php">HOME</a></li>
<li><a href="adminfinal.php">Product</a></li>
	 ...
	 if(!$conn)
      {
        ...
        //  echo "Failed to connect"<div class = "mysqli_connect_error"></div>;
      }
     else
      {
        $title="";
        $price="";
        $query="SELECT * FROM `products` AS p INNER JOIN `brands` AS b ON b.brand_id=p.product_brand AND INNER JOIN `categories` AS c ON c.cat_id=p.product_cat WHERE p.product_id='$id'";
